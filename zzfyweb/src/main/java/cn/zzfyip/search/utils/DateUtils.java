...
public class DateUtils {
    ...
    public final static String DATE_POINT_PATTERN = "yyyy.MM.dd";
     ...
     * @return yyyy-MM-dd Date
     */
    public static String formatDateToPointDate(Date date) {
    	try {
    		return DateUtils.formatDate(date, DateUtils.DATE_POINT_PATTERN);
    	} catch (Exception e) {
    		return null;
    	}
    }
